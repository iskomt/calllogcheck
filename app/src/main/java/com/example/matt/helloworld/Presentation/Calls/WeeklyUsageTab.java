...
import static com.example.matt.helloworld.Utilities.DateUtil.getFirstDayOfWeek;
import static com.example.matt.helloworld.Utilities.DateUtil.trim;

/**
 * A simple {@link Fragment} subclass.
 * Activities that contain this fragment must implement the
 * {@link WeeklyUsageTab.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link WeeklyUsageTab#newInstance} factory method to
 * create an instance of this fragment.
 */
public class WeeklyUsageTab extends Fragment {
    // TODO: Rename parameter arguments, choose names that match
    // the fragment initialization parameters, e.g. ARG_ITEM_NUMBER
    private static final String ARG_PARAM1 = "param1";
    private static final String ARG_PARAM2 = "param2";
    private String minutesUsedThisWeek = "";
    ...
    public void onStart() {
        super.onStart();
        TextView x =  (TextView)getActivity().findViewById(R.id.minutesUsedThisWeek);
        x.setText(MinutesUsedThisWeek());
        ...
        if ( ContextCompat.checkSelfPermission( this.getActivity(), Manifest.permission.READ_CALL_LOG ) == PackageManager.PERMISSION_GRANTED ) {
            ...
            ListView theView = (ListView) getActivity().findViewById(R.id.CallHistoryListViewWeekly);
    ...
    public static WeeklyUsageTab newInstance(String param1, String param2) {
        WeeklyUsageTab fragment = new WeeklyUsageTab();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_weekly_usage_tab, container, false);
    }
